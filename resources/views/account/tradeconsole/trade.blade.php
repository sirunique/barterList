                                ...
                                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                      <div class="carousel-item active">
                                        <img class="d-block" style="height: 150px; width:  245px; " src="{{asset("assets/images/email/1.png")}}" alt="First slide">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block" style="height: 150px; width:  245px;" src="{{asset("assets/images/email/2.png")}}" alt="Second slide">
                                      </div>
                                      <div class="carousel-item">
                                        <img class="d-block"  style="height: 150px; width:  245px;" src="{{asset("assets/images/email/3.png")}}" alt="Third slide">
                                      </div>
                                    </div>
                                  </div>
