           ...
           <br><br><br>
            <table id="datatable-buttons" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    @foreach ($adminDocs as $document)
                    <tr>
                        <td>
                            <a href="" class="glyphicon glyphicon-edit btn btn-primary"></a>
                            <a onclick="return confirm('Are you sure you want to delete {{$document->title}}?')" href="{{ route('admindoc.destroy', ['id'=> $document->id]) }}" class="glyphicon glyphicon-trash btn btn-danger"></a>
                        </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.adddoc') }}" method="post">
                    {{ csrf_field() }}
                    @if (count($errors) > 0)
