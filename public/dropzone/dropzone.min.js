                        ...
                        (this.prototype.Emitter = Emitter),
                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                fallback: function () {
                                    ...
                                    for (
                                        var c = this.element.getElementsByTagName(
                                                "div"
                                            ),
                                            d = 0,
                                            c = c;
                                ...
                                addedfile: function (a) {
                                    ...
                                    if (
                                        ...
                                        for (
                                            var h = a.previewElement.querySelectorAll(
                                                    "[data-dz-size]"
                                                ),
                                                i = 0,
                                                h = h;
                                ...
                                processing: function (a) {
                                    if (
                                        ...
                                        return (a._removeLink.innerHTML = this.options.dictCancelUpload);
                                },
                            ...
                            if (
                                ...
                                !(function c() {
                                    return (
                                        ...
                                        (a.hiddenFileInput = document.createElement(
                                            "input"
                                        )),
                        ...
                        value: function (a) {
                            ...
                            this._transformFiles(a, function (d) {
                                if (a[0].upload.chunked) {
                                    ...
                                    if (
                                        ((e.upload.finishedChunkUpload = function (
                                            d
                                        ) {
                                            var f = !0;
                                            (d.status = b.SUCCESS),
                    ...
                    },
                    {
                        ...
                        value: function (a, c) {
                            ...
                            e.open(i, j, !0),
                                ...
                                (e.withCredentials = !!this.options
                                    .withCredentials),
                                (e.onload = function (b) {
